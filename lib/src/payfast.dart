...
class PayFast extends StatefulWidget{
  ...
  PayFast({
    ...
    super.key,  
  }) : assert(data.containsKey('merchant_id'), 'Missing required key: merchant_id'),
     assert(data.containsKey('merchant_key'), 'Missing required key: merchant_key'),
     assert(data.containsKey('name_first'), 'Missing required key: name_first'),
     assert(data.containsKey('name_last'), 'Missing required key: name_last'),
     assert(data.containsKey('email_address'), 'Missing required key: email_address'),
     assert(data.containsKey('m_payment_id'), 'Missing required key: m_payment_id'),
...
class _PayFastState extends State<PayFast> {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: widget.payButtonStyle ?? ElevatedButton.styleFrom(
  ...
  String get endpointUrl => (widget.useSandBox) 
    ? Constants.onsitePaymentSandboxEndpoint : Constants.onsitePaymentLiveEndpoint;
      ...
      ..addJavaScriptChannel(
        ...
        onMessageReceived: (JavaScriptMessage message) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(message.message), behavior: SnackBarBehavior.floating),
          );
        },
      )
      ..loadRequest(Uri.parse('${widget.onsiteActivationScriptUrl}?uuid=$paymentIdentifier'));
