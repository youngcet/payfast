...
class Constants {
  ...
  static const List<String> transactionCompletedStatus = ['{transaction.completed}', 'completed'];
  static const List<String> transactionCancelledStatus = ['{transaction.cancelled}', '{transaction.closed}', 'closed'];
